...
const WHISPER_CPP_PATH = path_1.default.join(__dirname, '..', 'lib/whisper.cpp');
...
function whisperShell(command_1) {
    return __awaiter(this, arguments, void 0, function* (command, options = defaultShellOptions) {
